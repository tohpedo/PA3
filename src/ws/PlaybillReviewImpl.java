...
public class PlaybillReviewImpl implements PlaybillReview{
	...
	public Review[] populate() throws ParseException{
		...
		Review r = new Review("Playbill", "The Titanic", "10/10!", "Drama", dateTemp, "I really loved this movie" );
		Review x = new Review("Playbill", "The Departed", "Yay Web Services", "Drama", dateTemp, "Leonardo DiCaprio does a fabulous job in this movie" );
		output[0] = r;
		output[1] = x;
		return output;
	...
	public Review[] parseInfo() throws FileNotFoundException, ParseException{
		...
		while (s.hasNextLine())
		{
			...
			if (temp.length > 2)
			{
				allReviews[reviewCounter].setReviewSource("Playbill");
